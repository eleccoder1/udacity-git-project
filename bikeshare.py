...
def get_filters():
    ...
    while city_name.lower() not in CITY_DATA:
        # .lower() is used to change input as lowercase
    ...
    while month_name.lower() not in MONTHDATA:
        ...
        if month_name.lower() in MONTHDATA:
...
def time_stats(df):
    ...
    print("The most common month from the given fitered data is: " + MONTHDATA[common_month].title())
...
def trip_duration_stats(df):
    ...
    total_travel_time = round((df['Trip Duration'].sum())/(60*60*24),2)
    print("The total travel time from the given fitered data is: " + str(total_travel_time)+" Days")

    # display mean travel time
    mean_travel_time = round((df['Trip Duration'].mean())/(60),2)
    print("The mean travel time from the given fitered data is: " + str(mean_travel_time)+" Minutes")
